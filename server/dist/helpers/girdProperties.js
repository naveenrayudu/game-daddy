...
const generateGamePositions = () => {
    ...
    for (let boxes = 0; boxes < numberOfBoxes; boxes++) {
        ...
        let positionsToSkip = numberOfPointsPerBox;
        for (let position = boxes * numberOfPointsPerBox; position < boxes * numberOfPointsPerBox + numberOfPointsPerBox - 1; position = position + 2) {
...
//# sourceMappingURL=girdProperties.js.map